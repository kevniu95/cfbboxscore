...
def process(df : pd.DataFrame):
    ...
    return_cols = ['Date', 'game_id', 'Team','Location','Opponent','PF','PA','YPP_x','YPP_y','SuccessRate_x','SuccessRate_y','Turnovers_x','Turnovers_y']
...
if __name__ == '__main__':
    ...
    x_vars = ['YPP_x','SuccessRate_x','Turnovers_x']
    y_var = 'PF'
    ...
    try_model(base_x, y_pts, polys = 2)